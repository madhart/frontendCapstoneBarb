    ...
    <main>
      ...
      <section>
        ...
        <article>
          ...
          <p>The ways in which you can volunteer are diverse and varied such as:</p>
          <ul>
            <li>Sign on as a competitive cycling coach</li>
            <li>Volunteer in governance or committee work</li>
            <li>Help with events both Approved and Sanctioned</li>
            <li>Marshal races/events</li>
            <li>Organize sanctioned group rides</li>
            <li>Join the Board of Directors (annually at the AGM)</li>
          </ul>
          <p>
        ...
        <article>
          ...
          <ul>
            ...
            <li>Assist in the National Active Transportation Strategy</li>
            <li>
              Aid the federal E-bike regulation, education programs and rebate
              programs
            </li>
            <li>Continued development of the Newfoundland T&apos;Railway for cycling</li>
            <li>
        ...
        <article>
          ...
          <p>
            The Newfoundland T&apos;Railway Council is a non-profit corporation
            dedicated to the development of a recreational trail from St.
            John&apos;s to Port aux Basques using the former Canadian National
            railway line. Its mandate is to promote multi-use trail development
            and to preserve abandoned railway lines for future use such as
            hiking, biking, equestrian, snowmobile, ATV and cross-country ski
            trails.
          </p>
          <p>
            Learn more at{" "}
      ...
      <section>
        ...
        <p>
          Plan Link:{" "}
          <a href="#">Current Strategic Plan (PDF) – Link to be updated</a>
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>
            <a href="#">Policy 1 (PDF)</a>
          </li>
          <li>
            <a href="#">Policy 2 (PDF)</a>
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          <a href="#">Current CCN Registration</a>
        </p>
      </section>
